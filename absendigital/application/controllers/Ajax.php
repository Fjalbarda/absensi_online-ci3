        ...
        if ($dataabsen == 'datapgw') {
            ...
            foreach ($query->result() as $r) {
                $data[] = [
                    ...
                    $r->username,
                    $r->jenis_kelamin,
                    ($r->role_id == 1) ? '<span class="badge badge-danger ml-1">Supervisor</span>' : (($r->role_id == 2) ? '<span class="badge badge-primary ml-1">Asisten</span>' : (($r->role_id == 3) ? '<span class="badge badge-success ml-1">Calas</span>' : '<span class="badge badge-secondary ml-1">Tidak Ada Role</span>')),
