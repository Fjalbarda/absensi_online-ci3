<div class="container-fluid">
    <h1 class="my-4"><span class="fas fa-user-tie mr-2"></span>Data Anggota</h1>
    <div class="card mb-4">
        <div class="card-header">
            <div class="float-right">
                <div class="btn btn-primary" id="refresh-tabel-pegawai"><span class="fas fa-sync-alt mr-1"></span>Refresh Tabel</div>
                <button class="btn btn-success" data-toggle="modal" data-target="#addpegawaimodal" id="pgwadduser"><span class="fas fa-user-plus mr-1"></span>Tambah Anggota</button>
            </div>
        </div>
        <div class="card-body">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="addpegawaimodallabel"><span class="fas fa-user-plus mr-1"></span>Tambah Anggota</h5>
            </div>
            <div class="modal-body">
                <?= form_open_multipart('#', ['id' => 'addpegawai']) ?>
                <div class="form-group row">
                    <label for="nama_pegawai" class="col-sm-4 col-form-label">Nama Anggota</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_pegawai" name="nama_pegawai">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="username_pegawai" class="col-sm-4 col-form-label">Username Anggota</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="username_pegawai" name="username_pegawai">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="password_pegawai" class="col-sm-4 col-form-label">Password Anggota</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <?= form_dropdown('role_pegawai', ['' => 'Select Role', 1 => 'Supervisor', 2 => 'Asisten', 3 => 'Calas'], set_value('role_pegawai'), 'class="form-control" id="role_pegawai"'); ?>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="col-sm-4">Pas Foto Anggota</div>
                    <div class="col-sm-8">
